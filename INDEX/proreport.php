...
// 【主要针对 join query 做的索引】
//field value 变化不大的值 不需要加索引
//join 语句中，where 条件 xxx_id = 12 作为关键过滤值的字段必加索引
//作为join 连接的表，数据量在超过 1000时，并且占总查询次数较高的 必加索引
//varchar 和 char type field 尽量不加索引
//
1、[parse sql]
